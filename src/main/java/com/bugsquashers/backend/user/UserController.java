...
public class UserController {
    ...
    public ResponseEntity<ApiResponse<Object>> checkDuplicateUsername(@ModelAttribute @Valid CheckUsername username) {
        userService.validateDuplicateUsername(username.getUsername());
